...
from bot.middlewares.activity_and_session import UserActivityMiddleware, ResetSessionOnMenuMiddleware
...
async def test_user_activity_middleware_handles_callback():
    ...
    from aiogram.types import CallbackQuery, Chat as TelegramChat
